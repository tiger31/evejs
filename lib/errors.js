...
module.exports.MITestsTreeBuildError = class MITestsTreeBuildError extends Error {
	constructor(name) {
		super();
...
module.exports.MIUndetectedFrameworkEntity = class MIUndetectedFrameworkEntity extends Error {
...
module.exports.MINotPassed = class MINotPassed extends Error {
	constructor(tests) {
		super();
...
module.exports.MISeedingFailed  = class MISeedingFailed extends Error {
	constructor() {
		super();
