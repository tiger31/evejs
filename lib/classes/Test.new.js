...
module.exports = class Test extends Nested(Proxy(TaskRunnable(EventEmitter))) {
	/**
	 * @description
	 * Test state
	 * @type {string}
	 ...
	 * @param {number} [config.timeout=2000] - Runnable timeout
 	 */
	constructor({fn, title, runner, parent} = {}, {step = false, skip = false, parallel = false, timeout = 2000} = {}) {
		super();
