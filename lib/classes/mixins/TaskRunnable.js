...
module.exports = (Base) => class extends Runnable(Base) {
	...
	set parallel(value) {
		if (typeof value !== 'boolean')
			throw new TypeError('Parallel should be type of number');
	...
	set step(value) {
		if (typeof value !== 'boolean')
			throw new TypeError('Step should be type of number');
	...
	set skip(value) {
		if (typeof value !== 'boolean')
			throw new TypeError('Skip should be type of number');
